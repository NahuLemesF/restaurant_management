...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '79444596-f673-11f0-bb60-7870c89bb1a5:1-73';
...
CREATE TABLE `client` (
  ...
  `client_type` enum('COMMON','FREQUENT') DEFAULT NULL,
...
CREATE TABLE `dish` (
  ...
  `dish_type` enum('COMMON','POPULAR') DEFAULT NULL,
  `name` varchar(255) DEFAULT NULL,
...
-- Dump completed on 2026-01-25  1:13:49
